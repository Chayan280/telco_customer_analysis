...
Total Monthly Charges: 456.12K — indicates significant monthly revenue flow.
Total Tenure: 228K months — shows a large base of long-term customers.
Senior Citizens: 1,142 customers, representing a smaller but critical demographic.
Total Charges: 16.06M — cumulative revenue from all customers.
...
Gender distribution is almost equal, meaning no gender-based service preference.
4️⃣ Customer Count by Payment Method & Gender
...
Provide early-tenure customers (first 6 months) with:
Loyalty bonuses
Discounts
Better onboarding support 

✔ Improve Fiber Optic Customer Experience
Investigate reasons behind higher churn:
Pricing?
Installation issues?
Competitor offerings?
Provide special retention plans for fiber users.
...
On the other hand, Long-tenure customers and those using automatic payment methods provide higher revenue stability and show strong loyalty.
